<template>
  <f7-page name="store-locations">
    <div class="page">
      ...
      <div class="page-content pt-70 location-wraper bg-gray">
        <!-- Search backdrop -->
        ...
        <div class="tabs-swipeable-wrap tabs-height-auto">
          <div class="tabs">
                      ...
                      <div class="card-info">
                        <a href="/tracking/" class="button btn-dir">
                          <svg width="16" height="16" viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg">
                            <path
                              d="M8.00008 0.666676C6.54969 0.666676 5.13186 1.09677 3.9259 1.90256C2.71994 2.70836 1.78001 3.85367 1.22497 5.19366C0.669925 6.53365 0.524701 8.00814 0.807659 9.43067C1.09062 10.8532 1.78905 12.1599 2.81464 13.1855C3.84022 14.211 5.14689 14.9095 6.56942 15.1924C7.99195 15.4754 9.46644 15.3302 10.8064 14.7751C12.1464 14.2201 13.2917 13.2802 14.0975 12.0742C14.9033 10.8682 15.3334 9.45041 15.3334 8.00001C15.3311 6.05579 14.5578 4.19186 13.183 2.81709C11.8082 1.44232 9.9443 0.668969 8.00008 0.666676ZM8.00008 14C6.8134 14 5.65336 13.6481 4.66666 12.9888C3.67997 12.3295 2.91093 11.3925 2.45681 10.2961C2.00268 9.19975 1.88386 7.99335 2.11537 6.82947C2.34688 5.66558 2.91833 4.59648 3.75744 3.75737C4.59656 2.91825 5.66566 2.34681 6.82954 2.1153C7.99343 1.88379 9.19983 2.00261 10.2962 2.45673C11.3925 2.91086 12.3296 3.67989 12.9889 4.66659C13.6482 5.65328 14.0001 6.81332 14.0001 8.00001C13.9981 9.59071 13.3654 11.1157 12.2406 12.2405C11.1158 13.3653 9.59079 13.9981 8.00008 14Z"
                              fill="white"
                            />
                            <path
                              d="M7.99992 6C7.82311 6 7.65354 6.07024 7.52852 6.19526C7.40349 6.32029 7.33325 6.48986 7.33325 6.66667V11.3333C7.33325 11.5101 7.40349 11.6797 7.52852 11.8047C7.65354 11.9298 7.82311 12 7.99992 12C8.17673 12 8.3463 11.9298 8.47133 11.8047C8.59635 11.6797 8.66659 11.5101 8.66659 11.3333V6.66667C8.66659 6.48986 8.59635 6.32029 8.47133 6.19526C8.3463 6.07024 8.17673 6 7.99992 6Z"
                              fill="white"
                            />
                            <path
                              d="M7.99992 5.33333C8.36811 5.33333 8.66659 5.03485 8.66659 4.66667C8.66659 4.29848 8.36811 4 7.99992 4C7.63173 4 7.33325 4.29848 7.33325 4.66667C7.33325 5.03485 7.63173 5.33333 7.99992 5.33333Z"
                              fill="white"
                            />
                          </svg>
            ...
            <div id="tabPopular" class="tab">
              <div class="container">
                <h5 class="filter-text mt-0 mb-30">We have <strong class="text-black">13</strong> Outled ready to serve you</h5>
                <div class="list search-list mt-0 mb-20 dz-list searchbar-found">
                  <ul class="row">
                    <li class="store-card col-100 medium-50 card-list mb-20">
                      <div class="card-media">
            ...
            <div id="tabTopRated" class="tab">
              <div class="container">
                <h5 class="filter-text mt-0 mb-30">We have <strong class="text-black">28</strong> Outled ready to serve you</h5>
                <div class="list search-list mt-0 mb-20 dz-list searchbar-found">
                  <ul class="row">
                    <li class="store-card col-100 medium-50 card-list mb-20">
                      <div class="card-media">
