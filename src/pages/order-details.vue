<template>
  <f7-page name="order">
    <div class="page light">
      ...
      <div class="page-content order-details pt-60 pb-0">
        <div class="dz-banner-heading">
          <iframe
            src="https://www.google.com/maps/embed?pb=!1m14!1m12!1m3!1d14448.885880295826!2d75.81852004999999!3d25.128202299999998!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!5e0!3m2!1sen!2sin!4v1618811874293!5m2!1sen!2sin"
            ...
            <div class="icon-bx-left">
              <div class="icon-bx">
                <svg height="16" viewBox="0 0 32 32" width="16" xmlns="http://www.w3.org/2000/svg">
                  <path
                    d="m24.1 4.229a11.737 11.737 0 0 0 -8.735-3.212 11.869 11.869 0 0 0 -11.135 11.944 11.723 11.723 0 0 0 3.329 8 56.573 56.573 0 0 1 4.725 5.6c.646.853 1.269 1.717 1.886 2.588l1.015 1.433a1 1 0 0 0 1.631 0l1.492-2.1c.456-.645.927-1.283 1.421-1.912 1.641-2.13 3.39-4.119 5.038-5.952a11.753 11.753 0 0 0 -.667-16.389zm-8.1 13.771a5 5 0 1 1 5-5 5.006 5.006 0 0 1 -5 5z"
                  />
              ...
              <ul>
                  ...
                  <div class="item-content swipeout-content">
                    <div class="item-inner">
                      <div class="item-media">
                        <a href="/item-details/"><img src="img/menus/pic5.jpg" alt="" /></a>
                      </div>
                      <div class="item-info">
                        <div class="item-head">
                ...
                <li class="swipeout cart-item">
                  <div class="item-content swipeout-content">
                    <div class="item-inner">
                      <div class="item-media">
                        <a href="/item-details/"><img src="img/menus/pic2.jpg" alt="" /></a>
                      </div>
                      <div class="item-info">
                        <div class="item-head">
                ...
                <li class="swipeout cart-item">
                  <div class="item-content swipeout-content">
                    <div class="item-inner">
                      <div class="item-media">
                        <a href="/item-details/"><img src="img/menus/pic1.jpg" alt="" /></a>
                      </div>
                      <div class="item-info">
                        <div class="item-head">
                ...
                <li class="swipeout cart-item">
                  <div class="item-content swipeout-content">
                    <div class="item-inner">
                      <div class="item-media">
                        <a href="/item-details/"><img src="img/menus/pic3.jpg" alt="" /></a>
                      </div>
                      <div class="item-info">
                        <div class="item-head">
                ...
                <li class="swipeout cart-item">
                  <div class="item-content swipeout-content">
                    <div class="item-inner">
                      <div class="item-media">
                        <a href="/item-details/"><img src="img/menus/pic4.jpg" alt="" /></a>
                      </div>
                      <div class="item-info">
                        <div class="item-head">
                          <h6 class="item-title"><a href="/item-details/">Hot Coppuccino Latte with Mocha</a></h6>
