    ...
    <div class="page profile-wraper">
      <div class="navbar navbar-style-1">
        <div class="navbar-inner">
          ...
          <div class="right">
            <a href="/color-themes/" class="link">
      ...
      <div class="page-content content-area pt-60">
        <div class="profile-info">
          <div class="container">
            ...
            <div class="author-bx">
              <div class="dz-media">
                <img src="img/avatar/avatar2.jpg" alt="" />
              </div>
              ...
              <ul>
                ...
                <li>
                  ...
                  <div class="dz-content">
                    ...
                    <h5 class="title">Franklin Avenue, Corner St. London, 24125151</h5>
                  </div>
                </li>
              </ul>
            </div>
            ...
            <div data-space-between="20" data-slides-per-view="auto" data-centered-slides="false" class="swiper-container swiper-init main-swiper mb-30 overlay-swiper2">
              <div class="swiper-wrapper">
                <div class="swiper-slide">
                  <div class="card-overlay style-2">
                    <div class="dz-media">
                      <img src="img/order/pic1.png" alt="" />
                    </div>
                    <div class="dz-info">
                      <h5 class="title"><a href="/item-details/">Creamy Latte Coffee</a></h5>
                      <div class="dz-meta">
                        <ul>
                ...
                <div class="swiper-slide">
                  <div class="card-overlay style-2">
                    <div class="dz-media">
                      <img src="img/order/pic2.png" alt="" />
                    </div>
                    <div class="dz-info">
                      <h5 class="item-title title"><a href="/item-details/">Ombe Ice Coffee Latte</a></h5>
                      <div class="dz-meta">
                        <ul>
                          <li class="category">Beverages</li>
                          <li class="category">
