        ...
        <div class="container">
          <div class="logo-content">
            <ul class="pl-0 mb-0">
              <li class="row">
                <div class="col-50">
                  <h1 class="logo-name fs-35 mt-20">Kwitansi</h1>
                </div>
                <div class="col-50 text-align-right">
                  <i class="fas fa-download fs-22 mt-30"></i>
                </div>
              </li>
            </ul>
          </div>
          <div class="bg-gray pt-20">
            <div class="text-align-center">
              <p class="mb-0 mt-0">28 Oktober 2021</p>
              <h4 class="mt-5 mb-15">PEMBAYARAN TUNAI</h4>
            </div>
            <hr class="dash" />
            <li class="row pt-20 mb-5">
              <div class="col-50">Tiang besi telepon</div>
              <div class="col-25">20 Kg</div>
              <div class="col-25">20.000.000</div>
            </li>
            <li class="row mb-5">
              <div class="col-50">Kabel telepon</div>
              <div class="col-25">20 Kg</div>
              <div class="col-25">5.000.000</div>
            </li>
            <li class="row mb-20">
              <div class="col-50">PPN 10%</div>
              <div class="col-25"></div>
              <div class="col-25">2.500.000</div>
            </li>
            <hr class="dash" />
            <div class="total">
              <div class="row pt-10">
                ...
                <div class="col-25"></div>
                <div class="col-25">27.500.000</div>
              </div>
            </div>
            <hr class="dash" />
