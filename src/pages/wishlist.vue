          ...
          <ul class="row">
            <li class="col-100 medium-50 mb-20">
              <div class="wishlist-bx">
                ...
                <div class="dz-info">
                  <div class="dz-head">
                    <h6 class="item-title"><a href="/item-details/">Brown Hand Watch </a></h6>
                    <p>Variant : White Stripes</p>
                  </div>
                  <div class="dz-meta">
                    <ul>
                      <li class="price">$69.4</li>
                      <li>
            ...
            <li class="col-100 medium-50 mb-20">
              <div class="wishlist-bx">
                ...
                <div class="dz-info">
                  <div class="dz-head">
                    <h6 class="item-title"><a href="/item-details/">Possil Leather Watch</a></h6>
                    <p>Variant : White Stripes</p>
                  </div>
                  <div class="dz-meta">
                    <ul>
            ...
            <li class="col-100 medium-50 mb-20">
              <div class="wishlist-bx">
                ...
                <div class="dz-info">
                  <div class="dz-head">
                    <h6 class="item-title"><a href="/item-details/">Super Red Naiki Shoes </a></h6>
                    <p>Variant : White Stripes</p>
                  </div>
                  <div class="dz-meta">
                    <ul>
